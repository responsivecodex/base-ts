...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// GET items
itemsRouter.get("/", checkPermissions(ItemPermission.ReadItems), async (req: Request, res: Response) => {
  try {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// GET items/:id
itemsRouter.get("/:id", checkPermissions(ItemPermission.ReadItems), async (req: Request, res: Response) => {
